...
class HardwareOrderLineItemUpdateSchema(BaseModel):
    """
    HardwareOrderLineItemUpdateSchema
    """ # noqa: E501
    tracking_number: Optional[StrictStr] = None
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["tracking_number", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HardwareOrderLineItemUpdateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HardwareOrderLineItemUpdateSchema from a dict"""
        if obj is None:
            return None
