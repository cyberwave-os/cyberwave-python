...
class TrajectoryInitialStateSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["joint_positions", "joint_names"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrajectoryInitialStateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrajectoryInitialStateSchema from a dict"""
        if obj is None:
            return None
