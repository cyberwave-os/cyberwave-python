...
class TwinUniversalSchemaBatchPatchSchema(BaseModel):
    """
    Many JSON Pointer operations applied in order as one all-or-nothing batch.
    """ # noqa: E501
    operations: Annotated[List[TwinUniversalSchemaPatchSchema], Field(min_length=1, max_length=1000)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwinUniversalSchemaBatchPatchSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwinUniversalSchemaBatchPatchSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "operations": [TwinUniversalSchemaPatchSchema.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
