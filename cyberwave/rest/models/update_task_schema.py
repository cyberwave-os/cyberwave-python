...
class UpdateTaskSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "controller_policy_uuid", "default_parameters", "visibility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTaskSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTaskSchema from a dict"""
        if obj is None:
            return None
