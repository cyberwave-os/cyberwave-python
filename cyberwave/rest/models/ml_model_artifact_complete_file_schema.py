...
class MLModelArtifactCompleteFileSchema(BaseModel):
    """
    MLModelArtifactCompleteFileSchema
    """ # noqa: E501
    path: StrictStr
    storage_key: Optional[StrictStr] = None
    content_type: Optional[StrictStr] = None
    size_bytes: Optional[StrictInt] = None
    sha256: Optional[StrictStr] = None
    required: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["path", "storage_key", "content_type", "size_bytes", "sha256", "required"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MLModelArtifactCompleteFileSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MLModelArtifactCompleteFileSchema from a dict"""
        if obj is None:
            return None
