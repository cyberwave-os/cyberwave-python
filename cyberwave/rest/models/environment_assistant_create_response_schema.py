...
class EnvironmentAssistantCreateResponseSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["environment", "answer", "tool_calls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentAssistantCreateResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentAssistantCreateResponseSchema from a dict"""
        if obj is None:
            return None
