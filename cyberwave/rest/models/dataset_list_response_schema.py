...
class DatasetListResponseSchema(BaseModel):
    ...
    offset: StrictInt
    has_more: StrictBool
    __properties: ClassVar[List[str]] = ["datasets", "total", "limit", "offset", "has_more"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DatasetListResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DatasetListResponseSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "datasets": [DatasetSchema.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
