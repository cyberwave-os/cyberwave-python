...
class CloudNodeInstanceLogsResponse(BaseModel):
    """
    CloudNodeInstanceLogsResponse
    """ # noqa: E501
    instance_uuid: StrictStr
    logs: List[CloudNodeLogEntrySchema]
    content: StrictStr
    __properties: ClassVar[List[str]] = ["instance_uuid", "logs", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudNodeInstanceLogsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudNodeInstanceLogsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "logs": [CloudNodeLogEntrySchema.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
