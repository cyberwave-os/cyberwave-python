...
class AgentPlanSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prompt", "mlmodel_uuid", "llm_model_uuid", "llm_model_name", "twin_uuid", "controller_policy_uuid", "workflow_uuid", "mode", "simulation_backend"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentPlanSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentPlanSchema from a dict"""
        if obj is None:
            return None
