...
class OrganizationWorkspaceSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "slug", "organization", "owner", "owner_name", "member_count", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationWorkspaceSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationWorkspaceSchema from a dict"""
        if obj is None:
            return None
