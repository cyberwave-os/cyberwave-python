...
class WorkflowCloneSchema(BaseModel):
    """
    WorkflowCloneSchema
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "workspace_uuid", "environment_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowCloneSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowCloneSchema from a dict"""
        if obj is None:
            return None
