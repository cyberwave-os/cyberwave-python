...
IMAGEBYTES1_ANY_OF_SCHEMAS = ["bytes", "str"]
...
class ImageBytes1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ImageBytes1 with anyOf schemas: bytes, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ImageBytes1 with anyOf schemas: bytes, str. Details: " + ", ".join(error_messages))
        else:
            return instance
