...
IMAGEBYTES1_ANY_OF_SCHEMAS = ["bytearray", "str"]

class ImageBytes1(BaseModel):
    """
    ImageBytes1
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = ImageBytes1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ImageBytes1 with anyOf schemas: bytearray, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ImageBytes1 with anyOf schemas: bytearray, str. Details: " + ", ".join(error_messages))
        else:
            return instance
