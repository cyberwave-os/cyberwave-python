...
class CameraIntrinsicsSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fx", "fy", "cx", "cy", "width", "height"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CameraIntrinsicsSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CameraIntrinsicsSchema from a dict"""
        if obj is None:
            return None
