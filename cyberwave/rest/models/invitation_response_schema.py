...
class InvitationResponseSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["success", "message", "invitation_id", "expires_at", "resource"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvitationResponseSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvitationResponseSchema from a dict"""
        if obj is None:
            return None
