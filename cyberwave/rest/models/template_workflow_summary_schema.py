...
class TemplateWorkflowSummarySchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "execution_target", "run_on_edge"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateWorkflowSummarySchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateWorkflowSummarySchema from a dict"""
        if obj is None:
            return None
