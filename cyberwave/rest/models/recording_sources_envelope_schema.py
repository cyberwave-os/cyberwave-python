...
class RecordingSourcesEnvelopeSchema(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecordingSourcesEnvelopeSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecordingSourcesEnvelopeSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": RecordingSourcesSchema.from_dict(obj["items"]) if obj.get("items") is not None else None,
