...
class AdminRecordingEnvironmentSchema(BaseModel):
    """
    ...
    twins: List[AdminRecordingTwinSchema]
    __properties: ClassVar[List[str]] = ["uuid", "name", "slug", "workspace_slug", "twins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminRecordingEnvironmentSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminRecordingEnvironmentSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "twins": [AdminRecordingTwinSchema.from_dict(_item) for _item in obj["twins"]] if obj.get("twins") is not None else None
        })
        return _obj
