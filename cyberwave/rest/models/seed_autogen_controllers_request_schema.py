...
class SeedAutogenControllersRequestSchema(BaseModel):
    """
    SeedAutogenControllersRequestSchema
    """ # noqa: E501
    workspace_uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["workspace_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SeedAutogenControllersRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SeedAutogenControllersRequestSchema from a dict"""
        if obj is None:
            return None
