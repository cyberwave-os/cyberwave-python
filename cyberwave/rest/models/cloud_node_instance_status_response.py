...
class CloudNodeInstanceStatusResponse(BaseModel):
    """
    ...
    status: StrictStr
    __properties: ClassVar[List[str]] = ["slug", "workspace_slug", "instance_uuid", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudNodeInstanceStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudNodeInstanceStatusResponse from a dict"""
        if obj is None:
            return None
