...
class TaskSchema(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["uuid", "name", "description", "task_type", "controller_policy_uuid", "default_parameters", "workspace_uuid", "visibility", "created_at", "updated_at"]
