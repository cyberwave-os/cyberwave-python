...
class WorkflowObjectiveSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["text", "source", "fingerprint", "model_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowObjectiveSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowObjectiveSchema from a dict"""
        if obj is None:
            return None
