...
class RLTaskCloneSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "workspace_uuid", "environment_uuid", "project_uuid", "visibility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RLTaskCloneSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RLTaskCloneSchema from a dict"""
        if obj is None:
            return None
