...
class HardwareOrderLineItemCreateSchema(BaseModel):
    """
    HardwareOrderLineItemCreateSchema
    """ # noqa: E501
    asset_uuid: StrictStr
    quantity: Optional[StrictInt] = 1
    __properties: ClassVar[List[str]] = ["asset_uuid", "quantity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HardwareOrderLineItemCreateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HardwareOrderLineItemCreateSchema from a dict"""
        if obj is None:
            return None
