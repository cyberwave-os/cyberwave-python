...
class AssetControlOptionSchema(BaseModel):
    """
    AssetControlOptionSchema
    """ # noqa: E501
    option_id: StrictStr
    label: StrictStr
    controller_ref: ControllerRefSchema
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetControlOptionSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetControlOptionSchema from a dict"""
        if obj is None:
            return None
