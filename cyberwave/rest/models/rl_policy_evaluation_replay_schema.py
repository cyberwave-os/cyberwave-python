...
class RLPolicyEvaluationReplaySchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["seed", "recording_uuid", "environment_uuid", "twin_uuid", "timestamp_us"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RLPolicyEvaluationReplaySchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RLPolicyEvaluationReplaySchema from a dict"""
        if obj is None:
            return None
