...
class DefaultPaymentMethodSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "brand", "last4"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultPaymentMethodSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultPaymentMethodSchema from a dict"""
        if obj is None:
            return None
