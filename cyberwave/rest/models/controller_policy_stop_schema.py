...
class ControllerPolicyStopSchema(BaseModel):
    """
    ControllerPolicyStopSchema
    """ # noqa: E501
    twin_uuid: StrictStr
    workload_uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["twin_uuid", "workload_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControllerPolicyStopSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControllerPolicyStopSchema from a dict"""
        if obj is None:
            return None
