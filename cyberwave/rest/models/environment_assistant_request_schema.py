...
class EnvironmentAssistantRequestSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message", "cyberwave_api_key", "history", "mlmodel_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnvironmentAssistantRequestSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnvironmentAssistantRequestSchema from a dict"""
        if obj is None:
            return None
