...
class CloudNodeHeartbeatRequest(BaseModel):
    """
    CloudNodeHeartbeatRequest
    """ # noqa: E501
    slug: Optional[StrictStr] = None
    workspace_slug: Optional[StrictStr] = None
    instance_uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["slug", "workspace_slug", "instance_uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudNodeHeartbeatRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudNodeHeartbeatRequest from a dict"""
        if obj is None:
            return None
