...
class DeliveryAddressUpdateSchema(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["label", "address_line1", "address_line2", "city", "state", "postal_code", "country"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeliveryAddressUpdateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeliveryAddressUpdateSchema from a dict"""
        if obj is None:
            return None
