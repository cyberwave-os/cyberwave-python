...
class ResourceMetricsSchema(BaseModel):
    ...
    twin_count: StrictInt
    workflow_count: StrictInt
    __properties: ClassVar[List[str]] = ["workspace_uuid", "organization_uuid", "twin_count", "workflow_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResourceMetricsSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResourceMetricsSchema from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "twin_count": obj.get("twin_count"),
            "workflow_count": obj.get("workflow_count")
        })
        return _obj
