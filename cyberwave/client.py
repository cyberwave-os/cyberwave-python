...
class Cyberwave:
    ...
    def _setup_rest_client(self):
        ...
        def call_api_with_header_tracking(method, url, header_params=None, body=None, post_params=None, _request_timeout=None):
            ...
            return original_call_api(method, url, header_params, body, post_params, _request_timeout)
    ...
    def twin(self, asset_key: str, environment_id: Optional[str] = None, **kwargs) -> Twin:
        """
